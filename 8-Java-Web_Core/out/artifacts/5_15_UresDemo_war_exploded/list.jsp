...
<head>
    ...
    <script>
        ...
        window.onload = function () {
            var elementById = document.getElementById("firstCb");
            ...
            var elementById2 = document.getElementById("delSelected");
...
<div class="container">
    ...
    <form id="form" action="${pageContext.request.contextPath}/deleteSelectServlet" method="post">
        <table border="1" class="table table-bordered table-hover">
            ...
            <%--获取到数据并显示到页面上--%>
            <c:forEach items="${UserAll}" var="user" varStatus="s">
                <tr>
                    ...
                    <td><a class="btn btn-default btn-sm" href="update.html">修改</a>&nbsp;
                        <a class="btn btn-default btn-sm" href="javascript:deleteUser(${user.id})" id="">删除</a></td>
                </tr>
            </c:forEach>
        </table>
    </form>
